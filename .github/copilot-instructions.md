...
| 🔍 Quick Scan | **threat-pulse** | Rapid 15-minute broad-spectrum security scan across 9 domains: active incidents, identity anomalies (custom anomaly table with Identity Protection fallback), risky sign-ins, device process drift, rare process chains, critical asset exposure, SPN behavioral drift, email threats, UEBA behavioral signals, mailbox rule manipulation, privileged operations, and exploitable CVEs. 12 queries executed in parallel batches, producing a prioritized Threat Pulse Dashboard with color-coded verdicts (🔴 Escalate / 🟠 Investigate / 🟡 Monitor / ✅ Clear) and drill-down recommendations pointing to specialized skills. Cross-query correlation detects multi-domain attack patterns. Inline chat and markdown file output | "threat pulse", "quick scan", "security pulse", "morning hunt", "hunting sprint", "15 minute scan", "quick recon", "daily scan", "SOC pulse", "what should I focus on", "security overview", "threat overview", "broad scan", "posture check", "what can you do", "where do I start", "getting started", "help me investigate", "run a scan", "how do I use this", "show me what you can do", "what's going on" |
